...
@section('content')
    ...
    <div class="wg-box">
        <fieldset class="name">
            ...
            <input class="mb-10" type="text" name="Title" placeholder="Nhập tiêu đề tin tức..." value="{{ old('Title') }}">
            @if ($errors->has('Title'))
        ...
        <fieldset class="description">
            ...
            <textarea class="mb-10" name="Summary" placeholder="Nhập mô tả ngắn cho tin tức...">{{ old('Summary') }}</textarea>
        ...
        <fieldset class="description">
            ...
            <textarea class="mb-10" name="Content" placeholder="Nhập nội dung...">{{ old('Content') }}</textarea>
