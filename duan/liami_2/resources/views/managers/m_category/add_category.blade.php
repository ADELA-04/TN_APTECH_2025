                    ...
                    <div class="main-content">
                        ...
                        @endif
                                <form class="form-add-product" method="POST"
                                    ...
                                    <div class="wg-box">
                                        <fieldset class="name">
                                            <div class="body-title mb-10">Tên danh mục sản phẩm <span class="tf-color-1">*</span>
                                            </div>
                                            <input class="mb-10" type="text" name="CategoryName"
                                                placeholder="Nhập tên danh mục sản phẩm" required>
                                            @error('CategoryName')
                                        ...
                                        <div class="cols gap10">
                                            ...
                                            <a class="tf-button style-1 w-full"
                                                href="{{ route('managers.m_category.manager_category') }}">Hủy</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
