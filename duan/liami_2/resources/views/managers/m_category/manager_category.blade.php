                    ...
                    <div class="flex items-center justify-between gap10 flex-wrap">
                        <div class="wg-filter flex-grow">
                            ...
                            <form class="form-search" method="GET"
                                action="{{ route('managers.m_category.manager_category') }}">
                                <fieldset class="name">
                                    <input type="text" placeholder="Nhập tên danh mục cần tìm..." name="name" required
                                        value="{{ request('name') }}">
                                </fieldset>
                                            ...
                                            <div class="flex items-center justify-between gap20 flex-grow">
                                                <div class="name">
                                                    <a href="{{ route('category.edit', $category->CategoryID) }}"
                                                        class="body-title-2">{{ $category->CategoryName }}</a>
                                                </div>
