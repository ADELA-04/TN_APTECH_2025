            ...
            <div class="center">
                ...
                <div class="center-item">
                    ...
                    <ul class="menu-list">
                        ...
                        <li class="menu-item {{ request()->is('managers/m_product*') || request()->is('products*') || request()->is('products/create') || request()->is('products/update')? 'active' : '' }}">
                            <a href="{{ route('managers.m_product.manager_product') }}" class="{{ request()->is('managers/m_product/manager_product') || request()->is('managers/m_product*') || request()->is('managers/m_product/update_product') ? 'active' : '' }}" class="menu-item-button">
                        ...
                        <li
                            ...
                            <a href="{{ route('managers.m_category.manager_category') }}" class="{{ request()->is('managers/m_category/manager_category') || request()->is('managers/m_category*') || request()->is('category/create') || request()->is('managers/m_category/store')|| request()->is('category/*/edit') || request()->is('category/*') ? 'active' : '' }}" class="menu-item-button">
                                <div class="icon"><i class="icon-file-plus"></i></div>
                                <div class="text">Danh mục sản phẩm</div>
                            </a>
