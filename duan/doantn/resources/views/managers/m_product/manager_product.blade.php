                                    ...
                                    <div class="flex items-center justify-between gap20 flex-grow">
                                        ...
                                        {{-- <div class="body-text">
                                            <?php
                                                ...
                                                $detailUrl = "https://www.facebook.com/thom.877056" ;

                                                // Tạo mã QR từ URL
                                                $qrCodeUrl = "https://api.qrserver.com/v1/create-qr-code/?data=" . urlencode($detailUrl) . "&size=100x100";
                                            ?>
                                            <img src="{{ $qrCodeUrl }}" alt="QR Code" style="width: 50px; height: 50px;">
                                        </div> --}}
